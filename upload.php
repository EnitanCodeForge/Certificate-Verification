...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form role="form" action="up.php" method="post" >
                    <div>
               ...
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="StuRegNum" class="form-control" type="text" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Gender</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-file btn-info"><span class="fileupload-new"><i class="fa fa-photo "></i> Select image</span><span class="fileupload-exists">Change</span><input type="file"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="VeriNum" class="form-control" type="text" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Institution_id</label>
                                            <input name="InstituteID" class="form-control" type="text" required>
                                        </div>
                       ...
                       <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                         ...
                                         <div class="form-group">
                                                    ...
                                                    <input name="SerialNo" class="form-control" type="text" required>
                                         </div>
                                        <div class="form-group">
                                                    <label>Registration Number</label>
                                                    <input name="RegNum" class="form-control" type="text" required>
                                         </div>
                                          <div class="form-group">
                                        ...
                                        <div class="form-group" required>
                                            <label>Year of Graduation</label>
                                                <select name="YearOfGrad" class="form-control">
                                                   <option>2018</option>
                                                   <option>2017</option>
                                                   <option>2016</option>
                                                   <option>2015</option>
                ...
                <center>
                    <br/>
                    <button type="submit" name="upload" class="btn btn-info"><i class="fa fa-save "></i> Upload </button>
                </center>
         </form>
